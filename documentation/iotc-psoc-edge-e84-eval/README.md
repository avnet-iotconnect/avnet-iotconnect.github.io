...
1. Download the example **E84 Eval Kit Dashboard** dashboard: [psoc-edge84-eval-kit-dashboard.json](./psoc-edge84-ai-gesture-dashboard.json)
...
![e84-eval-dashboard.png](./media/e84-eval-dashboard.png)
