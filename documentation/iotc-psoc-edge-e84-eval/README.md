...
This guide will walk through the steps of setting up the Infineon PSOC™ Edge E84 Eval Kit 
for connecting to Avnet's /IOTCONNECT platform and demonstrating a sound recognition [DEEPCRAFT™ Ready Model](https://www.infineon.com/design-resources/embedded-software/deepcraft-edge-ai-solutions/deepcraft-ready-models).

## 2. Prerequisites
* **PSOC™ Edge E84 Eval Kit** ([Buy Now](https://www.newark.com/infineon/kitpse84aitobo1/ai-eval-kit-32bit-arm-cortex-m55f/dp/49AM4459))
...
* Download the pre-made [Device Template](https://github.com/avnet-iotconnect/avnet-iotc-mtb-psoc-edge-rm/blob/main/files/device-template.json) for the Edge E84 Eval Kit.
...
6. Select the `PSOC Edge E84 Eval Kit` and click **Next**.
...
## 9. Hardware Setup
1. Connect the USB-C port from the board to your PC.
...
* Check the serial terminal to ensure MQTT data is being generated.
...
1. Download the example **E84 Eval Kit Dashboard** dashboard: [Infineon-PSOC-E84-Imagimob-Baby-Cry-Ready-Model-dashboard.json](./Infineon-PSOC-E84-Imagimob-Baby-Cry-Ready-Model-dashboard.json)
...
6. **Enter** a name (such as `Baby Cry Demo`) and **Click** *Save* the finalize the import
...
![baby-cry-dashboard.png](./media/baby-cry-dashboard.png)
...
* [Purchase the Infineon PSOC Edge E84 Eval Kit](https://www.newark.com/infineon/kitpse84aitobo1/ai-eval-kit-32bit-arm-cortex-m55f/dp/49AM4459)
